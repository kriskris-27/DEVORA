...
import AnimatedAuthCard from "@/components/animated-auth-card"
...
export default function SignupPage() {
  ...
  return (
    <div className="relative min-h-svh">
      ...
      />
      <main className="relative z-[1] min-h-svh grid place-items-center px-4">
        <AnimatedAuthCard>
          <Card className="w-full md:w-[480px] rounded-3xl bg-white/10 backdrop-blur-md border border-white/10 text-white shadow-2xl">
            <CardHeader className="space-y-2">
              {/* Add Devora logo at the top of the card */}
              <img
                src="/images/devora-logo.png"
                alt="Devora"
                className="mx-auto h-8 md:h-10 w-auto drop-shadow-[0_1px_6px_rgba(0,0,0,0.45)]"
              />
              <CardTitle className="text-2xl md:text-3xl font-semibold text-white text-center">
                Create your account
              </CardTitle>
            </CardHeader>
            <CardContent className="space-y-6">
              ...
              <div className="grid gap-3">
                ...
                {/* Simple route switch line below GitHub button */}
                <p className="text-center text-sm text-white/70">
                  {"Already have an account? "}
                  <Link href="/login" className="underline underline-offset-4 text-white hover:text-white">
                    Log in
                  </Link>
                </p>
              </div>
